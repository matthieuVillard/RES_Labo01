...
public class BufferedIOBenchmark {
	...
	public BufferedIOBenchmark() throws FileNotFoundException{
		recorder = new FileRecorder("./out/result.csv");
		recorder.init();
		recorder.println("operation;strategy;blockSize;fileSizeInBytes;durationInMs");
	}
